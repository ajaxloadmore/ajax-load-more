...
export function wooInit(alm) {
	...
	if (!container) {
		console.warn(
			'ALM WooCommerce: Unable to locate container element. Get more information -> https://ajaxloadmore.com/docs/add-ons/woocommerce/#alm_woocommerce_container',
		);
		return;
	}
	...
	if (count > 1) {
		...
		console.warn(
			'ALM WooCommerce: Multiple containers with the same classname or ID found. The WooCommerce add-on requires a single container to be defined. Get more information -> https://ajaxloadmore.com/docs/add-ons/woocommerce/',
		);
	}
	...
	if (item) {
		...
		console.warn(
			'ALM WooCommerce: Unable to locate products. Get more information -> https://ajaxloadmore.com/docs/add-ons/woocommerce/#alm_woocommerce_products',
		);
	}
